...
let EntityExists = class EntityExists {
    ...
    validate(id, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const found = yield this.dataSource
...
EntityExists = __decorate([
    (0, class_validator_1.ValidatorConstraint)({ name: 'entityExists', async: true }),
