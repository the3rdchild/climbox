...
class CreateCollectionDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, isPublic: { required: false, type: () => Boolean }, userId: { required: true, type: () => Number }, siteIds: { required: true, type: () => [Number] } };
    }
}
__decorate([
...
], CreateCollectionDto.prototype, "siteIds", void 0);
