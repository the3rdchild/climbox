...
exports.SurveyPointDataRangeDto = void 0;
...
class SurveyPointDataRangeDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { siteId: { required: true, type: () => Number }, surveyPointId: { required: true, type: () => Number } };
    }
}
__decorate([
...
], SurveyPointDataRangeDto.prototype, "siteId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1 }),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsNumber)(),
    ...
    __metadata("design:type", Number)
], SurveyPointDataRangeDto.prototype, "surveyPointId", void 0);
exports.SurveyPointDataRangeDto = SurveyPointDataRangeDto;
