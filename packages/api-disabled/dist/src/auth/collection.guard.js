...
exports.CollectionGuard = void 0;
const core_1 = require("@nestjs/core");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const collections_entity_1 = require("../collections/collections.entity");
let CollectionGuard = class CollectionGuard {
    constructor(collectionRepository, reflector) {
    ...
    canActivate(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!Number.isNaN(parseInt(collectionId, 10))) {
                const hasCollection = yield this.collectionRepository.findOne({
                    where: {
